...
public class Banco {
    ...
    public static void inicia(){
        ...
        Usuario usuario1 = new Usuario(1, "Tosador", 'F', "09/05/1996", "30212121", "tosador@petshop.com", "521454123", "tosador", "administrador");
        Usuario usuario2 = new Usuario(2, "Banhista", 'F', "09/05/1996", "30212122", "banhista@petshop.com", "451244123", "banhista", "funcionario");
        ...
        Servico servico1 = new Servico(1, "Banho Simples", 18);
        Servico servico2 = new Servico(2, "Banho e Tosa", 30);
        Servico servico3 = new Servico(3, "Corte de Unha", 15);
        Servico servico4 = new Servico(4, "Banho Raças Grandes", 25);
        Servico servico5 = new Servico(6, "Animal exotico", 3);
